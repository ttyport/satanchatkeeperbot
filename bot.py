...
from captcha_generator import generate_captcha, delete_captcha
...
async def captcha(message: types.Message):
    ...
    await bot.send_photo(message.chat.id, types.InputFile(f"{username}.png"), f"Добро пожаловать, @{username}!\nЧтобы "
